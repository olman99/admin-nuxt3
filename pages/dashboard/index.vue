...
const filters = ["Name", "Title", "Role"];
const specialFilters = ["Last week", "Last Month", "All Roles"];
const columns = [
  { label: "Name", class: "" },
  { label: "Title", class: "hidden lg:table-cell" },
  { label: "Email", class: "hidden sm:table-cell" },
  { label: "Role", class: "hidden sm:table-cell" },
];
...
const options = [
  { label: "Crear Pedido", variant: "primary", action: "" },
  { label: "Importar", variant: "success" },
];
</script>
